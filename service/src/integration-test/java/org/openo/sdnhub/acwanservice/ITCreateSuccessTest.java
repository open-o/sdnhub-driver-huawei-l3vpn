...
import org.openo.sdnhub.acwanservice.moco.AcwanCreateHttpsServer;
import org.openo.sdnhub.acwanservice.moco.AcwanDriverSuccessServer;
...
public class ITCreateSuccessTest extends TestManager {

    private AcwanDriverSuccessServer acwanServer = new AcwanDriverSuccessServer();
    ...
    public void test() throws ServiceException {
        File createFile = new File("src/integration-test/resources/AcWanDriverSvc/create.json");
