...
public class AcwanCreateHttpsServer extends MocoHttpsServer {

    public AcwanCreateHttpsServer() {
        super();
    }
    ...
    public void addRequestResponsePairs() {
        ...
        this.addRequestResponsePair("src/integration-test/resources/AcWanDriverSvc/moco/getL3vpn.json",
                new AcWanSuccessResponseHandler());
        this.addRequestResponsePair("src/integration-test/resources/adapter/deletesuccess.json",
                new AcWanSuccessResponseHandler());
