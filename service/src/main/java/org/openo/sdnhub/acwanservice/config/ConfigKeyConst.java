...
package org.openo.sdnhub.acwanservice.config;
...
public class ConfigKeyConst {
    ...
    public static final String LABEL_APPLY_MODE = "label-apply-mode";
    ...
    public static final String SR_IP_PREFIX = "ip-prefix";
